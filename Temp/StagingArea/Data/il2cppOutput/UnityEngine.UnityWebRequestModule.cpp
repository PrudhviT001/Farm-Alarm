...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* Application_get_absoluteURL_m74A990787FC6E2EC8D63638106AF23B18D10969C (const RuntimeMethod* method);
...
{
	{
		...
		VirtActionInvoker1< int32_t >::Invoke(6 /* System.Void UnityEngine.Networking.DownloadHandler::ReceiveContentLength(System.Int32) */, __this, ((int32_t)((int32_t)L_0)));
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void UnityWebRequest_set_url_m27BCB349EB7FA610705EA03CC817A1A394BA392F (UnityWebRequest_tB75B39F6951CA0DBA2D5BEDF85FDCAAC6026A37E * __this, String_t* ___value0, const RuntimeMethod* method)
{
	...
	String_t* V_0 = NULL;
	{
		...
		String_t* L_0;
		L_0 = Application_get_absoluteURL_m74A990787FC6E2EC8D63638106AF23B18D10969C(/*hidden argument*/NULL);
		V_0 = L_0;
		String_t* L_1 = ___value0;
		String_t* L_2 = V_0;
		IL2CPP_RUNTIME_CLASS_INIT(WebRequestUtils_t3FE2D9FD71A02CD3AF8C91B81280F59E5CF26392_il2cpp_TypeInfo_var);
		String_t* L_3;
		L_3 = WebRequestUtils_MakeInitialUrl_mD575E2FEAC3685E9030B528769BFAC7CE0534290(L_1, L_2, /*hidden argument*/NULL);
		UnityWebRequest_InternalSetUrl_mE850CF14CE4F5EE57063771AC9B0C686C4856F25(__this, L_3, /*hidden argument*/NULL);
		return;
	}
}
// UnityEngine.Networking.UnityWebRequest/UnityWebRequestError UnityEngine.Networking.UnityWebRequest::SetUrl(System.String)
...
IL_001c:
		{
			...
			VirtActionInvoker1< uint8_t >::Invoke(31 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_9, (uint8_t)((int32_t)32));
			goto IL_006c;
		}
...
IL_0046:
		{
			...
			VirtActionInvoker1< uint8_t >::Invoke(31 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_19, L_23);
			goto IL_006c;
		}
...
IL_0060:
		{
			...
			VirtActionInvoker1< uint8_t >::Invoke(31 /* System.Void System.IO.Stream::WriteByte(System.Byte) */, L_24, L_28);
		}
...
IL_007d:
		{
			...
			L_34 = VirtFuncInvoker0< ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* >::Invoke(35 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_33);
			V_5 = L_34;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WebRequestUtils_MakeUriString_mD6C6C27478BADC8EDF42621924F2ACD6D1B21E7D (Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * ___targetUri0, String_t* ___targetUrl1, bool ___prependProtocol2, const RuntimeMethod* method)
{
	...
	}
	{
		...
		if ((((int32_t)L_4) < ((int32_t)((int32_t)il2cpp_codegen_add((int32_t)L_6, (int32_t)2)))))
		{
			goto IL_0032;
		}
	}
	{
		...
		Il2CppChar L_10;
		L_10 = String_get_Chars_m9B1A5E4C8D70AA33A60F03735AF7B77AB9DBBA70(L_7, ((int32_t)il2cpp_codegen_add((int32_t)L_9, (int32_t)1)), /*hidden argument*/NULL);
...
IL_0033:
	...
	}
	{
		...
		StringBuilder__ctor_mE87B9746FC40A7ECC0149A24685BD0713459FAF1(L_15, L_12, L_14, /*hidden argument*/NULL);
		V_2 = L_15;
		StringBuilder_t * L_16 = V_2;
		StringBuilder_t * L_17;
		L_17 = StringBuilder_Append_m1ADA3C16E40BF253BCDB5F9579B4DBA9C3E5B22E(L_16, ((int32_t)58), /*hidden argument*/NULL);
		String_t* L_18 = V_0;
		bool L_19;
		L_19 = String_op_Equality_m2B91EE68355F142F67095973D32EB5828B7B73CB(L_18, _stringLiteralEB3DF58228CDA6AA5325549ADFCEDF52FC5CBF6A, /*hidden argument*/NULL);
		V_3 = L_19;
		bool L_20 = V_3;
		if (!L_20)
		{
	...
	{
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_21 = ___targetUri0;
		String_t* L_22;
		L_22 = Uri_get_AbsolutePath_mB845A99D0CEB442AAF90B24A95EE7509C34C6306(L_21, /*hidden argument*/NULL);
		V_4 = L_22;
		String_t* L_23 = V_4;
		bool L_24;
		L_24 = String_Contains_mA26BDCCE8F191E8965EB8EEFC18BB4D0F85A075A(L_23, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, /*hidden argument*/NULL);
		V_5 = L_24;
		bool L_25 = V_5;
		if (!L_25)
		{
	...
	}
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(WebRequestUtils_t3FE2D9FD71A02CD3AF8C91B81280F59E5CF26392_il2cpp_TypeInfo_var);
		String_t* L_27;
		L_27 = WebRequestUtils_URLDecode_m1B0D9D85074E0B8390C890B9E56F389F4EC6C8DF(L_26, /*hidden argument*/NULL);
		V_4 = L_27;
	}
...
IL_0087:
	{
		String_t* L_28 = V_4;
		bool L_29;
		L_29 = String_StartsWith_mDE2FF98CAFFD13F88EDEB6C40158DDF840BFCF12(L_28, _stringLiteral225454A90D745E7A7A5DE5C12169566FBC05370D, /*hidden argument*/NULL);
		if (!L_29)
		{
			goto IL_00b0;
		}
	...
	}
	{
		String_t* L_32 = V_4;
		Il2CppChar L_33;
		L_33 = String_get_Chars_m9B1A5E4C8D70AA33A60F03735AF7B77AB9DBBA70(L_32, 6, /*hidden argument*/NULL);
...
IL_00b1:
	...
	}
	{
		...
		L_36 = StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_35, _stringLiteral218F5A08519088A96BE3C1074984C53EA49F1CCA, /*hidden argument*/NULL);
		StringBuilder_t * L_37 = V_2;
		String_t* L_38 = V_4;
		String_t* L_39;
		L_39 = String_Substring_mB6B87FD76552BBF6D4E2B9F07F857FE051DCE190(L_38, 5, /*hidden argument*/NULL);
...
IL_00d6:
	{
		...
		L_43 = StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_41, L_42, /*hidden argument*/NULL);
	}
...
IL_00e9:
	{
		...
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_47 = ___targetUri0;
		String_t* L_48;
		L_48 = Uri_get_PathAndQuery_m0FFF28F15DF953C5866C2A0DEEA2034ECE6A0F35(L_47, /*hidden argument*/NULL);
		StringBuilder_t * L_49;
		L_49 = StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_46, L_48, /*hidden argument*/NULL);
		StringBuilder_t * L_50 = V_2;
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_51 = ___targetUri0;
		String_t* L_52;
		L_52 = Uri_get_Fragment_m1734B2D3F27F38AA342CB65885DE732160501E72(L_51, /*hidden argument*/NULL);
		StringBuilder_t * L_53;
		L_53 = StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_50, L_52, /*hidden argument*/NULL);
...
IL_010d:
	{
		...
		bool L_57;
		L_57 = String_Contains_mA26BDCCE8F191E8965EB8EEFC18BB4D0F85A075A(L_56, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, /*hidden argument*/NULL);
		V_8 = L_57;
		bool L_58 = V_8;
		if (!L_58)
		{
	...
	{
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_59 = ___targetUri0;
		String_t* L_60;
		L_60 = Uri_get_OriginalString_mBD94B4BB84AE9C051C1CA8BA33C14D5BAD25B0AC(L_59, /*hidden argument*/NULL);
		V_7 = L_60;
		goto IL_0132;
	}
...
IL_0128:
	{
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_61 = ___targetUri0;
		String_t* L_62;
		L_62 = Uri_get_AbsoluteUri_mC494374C2A3B1DFC9C3DC6CCB8A8A758580C11DA(L_61, /*hidden argument*/NULL);
		V_7 = L_62;
		goto IL_0132;
	}
